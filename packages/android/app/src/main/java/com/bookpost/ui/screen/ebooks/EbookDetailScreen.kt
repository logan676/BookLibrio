...
fun EbookDetailScreen(
    ebookId: Int,
    onNavigateBack: () -> Unit,
    onReadClick: (Int, Boolean) -> Unit,
    viewModel: EbookDetailViewModel = hiltViewModel()
) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(uiState.ebook?.title ?: "") },
                navigationIcon = {
                ...
                Column(
                    ...
                    Row(
                        ...
                        Column(
                            ...
                            ebook.fileType?.let { type ->
                                Text(
                                    text = "格式: ${type.uppercase()}",
                    ...
                    Button(
                        onClick = { onReadClick(ebook.id, ebook.isPdf) },
                        modifier = Modifier.fillMaxWidth()
                    ) {
